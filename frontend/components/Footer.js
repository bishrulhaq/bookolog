const Footer = () => {
  return (
    <footer className="sticky top-[100vh]">
      <div className="justify-between bg-gray-100 dark:bg-gray-800 py-5 dark:text-white">
          ...
          <div className="sm:flex sm:flex-wrap sm:-mx-4 md:py-4 justify-center">
            ...
            <div className="px-4 mt-4 sm:w-1/3 xl:w-1/6 sm:mx-auto xl:mt-0 xl:ml-auto">
              ...
              <div className="flex sm:justify-center xl:justify-start">
                {/* <a href="href://www.google.com" className="w-8 h-8 border border-2 border-gray-400 rounded-full text-center py-1 text-gray-600 hover:text-white hover:bg-blue-600 hover:border-blue-600">
                  <i className="fab fa-facebook"></i>
                </a>
                <a href="href://www.google.com" className="w-8 h-8 border border-2 border-gray-400 rounded-full text-center py-1 ml-2 text-gray-600 hover:text-white hover:bg-blue-400 hover:border-blue-400">
                  <i className="fab fa-twitter"></i>
                </a>
                <a href="href://www.google.com" className="w-8 h-8 border border-2 border-gray-400 rounded-full text-center py-1 ml-2 text-gray-600 hover:text-white hover:bg-red-600 hover:border-red-600">
