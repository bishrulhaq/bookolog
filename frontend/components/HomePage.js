...
export default async function App({ searchParams }) {
  ...
  return (
    <>
      <div class="lg:flex">
        <div class="lg:w-8/12 xl:w-75/100 p-2 b-shadow m-auto">
          <Breadcrumbs />
          <Carousel />
        </div>

        <div class="lg:w-4/12 xl:w-25/100 p-2 b-shadow m-auto">
      ...
      <div className="py-2 mx-auto lg:py-2">
        <div className="text-center p-8 md:p-12 mb-8">
          <a href="#" className="bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-blue-400 mb-2">
            <svg className="w-2.5 h-2.5 mr-1.5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
