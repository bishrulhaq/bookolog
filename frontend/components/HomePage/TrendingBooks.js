        ...
        <div className="w-full h-[27rem] overflow-y-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
            ...
            <ul className="my-4 space-y-3">
                {trendingBooks.map((book, index) => (
                    <li key={index}>
                        <Link href={`/book/${book.slug}/${book.uuid}`}  className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-200 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
