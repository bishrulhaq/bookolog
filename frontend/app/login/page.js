...
export default function RegisterPage() {
    ...
    return (<>
        <section className="py-10 flex items-center justify-center">
            <div
                className="dark:border-gray-700 dark:bg-gray-800 bg-gray-200 flex rounded-3xl shadow-lg max-w-4xl p-5 items-center b-shadow">
                <div className="md:w-1/2 px-5">

                    <h2 className="font-bold text-2xl text-[#002D74] dark:text-white">Login</h2>
                    <p className="text-xs mt-4 text-[#002D74] dark:text-white">If you are already a member, easily
                        log in</p>
                    ...
                    >
                        {({
                            ...
                            {errors.email && touched.email && (
                                <span className="text-red-600 pt-3">{errors.email}</span>)}
                            ...
                            <button
                                type="submit"
                                className="bg-[#002D74] text-white p-4 rounded-xl font-bold mt-8"
                            ...
                            {errors.general && (
                                <span className="text-red-600 pt-3">{errors.general}</span>)}
                        </form>)}
                    ...
                    <Link href="/register"
                          className="mt-3 text-xs flex justify-between items-center text-[#002D74] dark:text-white">
                        <p>Don't have an account?</p>
                        <button
                            className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300 dark:text-white dark:bg-gray-800">Register
                        </button>
                    </Link>
