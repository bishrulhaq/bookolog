...
const batchSize = 20;
const totalRecords = countryData.length;
...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        async function insertInBatches(startIndex) {
            ...
            const recordsToInsert = countryData.slice(startIndex, endIndex);

            if (recordsToInsert.length > 0) {
                await queryInterface.bulkInsert('country', recordsToInsert, {});
